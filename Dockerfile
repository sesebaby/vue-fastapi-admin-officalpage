# 使用国内镜像源的Node.js基础镜像
FROM registry.cn-hangzhou.aliyuncs.com/library/node:18.12.0-alpine3.16 AS web-builder
...
# 使用国内镜像源的Python基础镜像
FROM registry.cn-hangzhou.aliyuncs.com/library/python:3.11-slim-bullseye
